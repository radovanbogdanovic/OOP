...
void main() {
	...
	catch (Greske g)
	{
		switch (g)
		{
		case NEMA_MESTA: cout << "Nema mesta u nizu"; break;
		case POGRESAN_INDEKS: cout << "Unesite drugi indeks"; break;
		case PRAZAN_NIZ: cout << "Niz je prazan"; break;
		case PROBLEM_SA_FAJLOM: cout << "Problem sa fajlom"; break;
		}
	}
	try
	{
